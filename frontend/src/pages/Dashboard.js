...
const Dashboard = () => {
  ...
  // Get five random products for display
    ...
    <div className="dashboard">
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card">
          ...
          <div className="stat-info">
            <h3>M{stats.totalRevenue.toFixed(2)}</h3>
            <p>Total Revenue</p>
          </div>
        </div>
            ...
            {featuredProducts.map((product) => (
              <div key={product.id} className="product-card">
                <img 
                  ...
                  onError={(e) => {
                    e.target.src = 'https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=200&h=150&fit=crop';
                  }}
                />
